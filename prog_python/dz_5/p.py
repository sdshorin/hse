...
def main():
	...
	with open("input.txt") as f:
		while True:
			...
			counted[school] = SchoolResult(counted[school].activity + 1, counted[school].school_num)
	...
	print(" ".join([str(i.school_num) for i in counted if i.activity == top_activity]))
